...
export class Migration1733775769363 implements MigrationInterface {
    name = 'Migration1733775769363'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."orders_status_enum" AS ENUM('Собран', 'Ожидание', 'Оплачен', 'Отклонен')`);
