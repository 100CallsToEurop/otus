...
export class Migration1736151526599 implements MigrationInterface {
    name = 'Migration1736151526599'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "histories" ("id" SERIAL NOT NULL, "orderId" integer NOT NULL, "balance" integer NOT NULL, "withdrawal_amount" integer NOT NULL, "transaction_date" TIMESTAMP NOT NULL, "billingId" integer, CONSTRAINT "PK_36b0e707452a8b674f9d95da743" PRIMARY KEY ("id"))`);
