...
export class Migration1736249548348 implements MigrationInterface {
    name = 'Migration1736249548348'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "availability_slots" ("id" SERIAL NOT NULL, "orderId" integer NOT NULL, "date" TIMESTAMP NOT NULL, "courierId" integer, CONSTRAINT "PK_70765e8e17c8f6374060d70589a" PRIMARY KEY ("id"))`);
